...
class ListView extends Component {
  ...
  if (autoHeight) {
    // [className, downLoading && styles.downLoadingStyle,  styles.scrollView, styles.autoHeight]
    return (
      <ScrollView
        ref={node => {
        ...
        "downLoadingStyle"} scrollView ${styles.autoHeight}`}
        style={{ ...style }}
        scrollY={canScrollY}
        lowerThreshold={80}
        ...
        >
          ...
          >
            <View style={blockStyle}>
              ...
              {/* default page */}
              {footerLoading && (
                <View className={styles.loading} style={{
                  marginBottom: '6px',
                  width: '100%',
                  textAlign: 'center',
                  fontSize: '12px',
  ...
  return (
    <Skeleton isLoaded={isLoaded || isError} selector={selector}>
      <ScrollView
        ...
        className={[className, styles.scrollView]}
        style={style}
        scrollY={canScrollY}
        lowerThreshold={80}
        onScrollToLower={this.handleScrollToLower}
        ...
        >
          ...
          >
            <View style={blockStyle}>
              ...
              {/* default page */}
              {footerLoading && (
                <View className={styles.loading}>{footerLoadingText}</View>
              )}
              {/* custom footer loading page*/}
              {customFooterLoading && this.props.renderFooterLoading}
              {/* default footer loaded page*/}
              {footerLoaded && (
                <View className={styles.loaded}>{footerLoadedText}</View>
              )}
              {/* custom footer loaded page*/}
              {customFooterLoaded && this.props.renderFooterLoaded}
            </View>
