  ...
  promisify = function (a) {
    return function (b) {
      ...
      return new Promise(function (f, g) {
        a.apply(
          void 0,
          [Object.assign({}, b, { success: f, fail: g })].concat(d),
        ),
          (Promise.prototype.finally = function (h) {
...
var wxPromise = function () {
  for (var a in wx)
    wx.hasOwnProperty(a) &&
      (wx.pro[a] =
        (/^on|^create|Sync$|Manager$|^pause/.test(a) &&
          'createBLEConnection' != a) ||
        'stopRecord' == a ||
        'stopVoice' == a ||
        'stopBackgroundAudio' == a ||
        'stopPullDownRefresh' == a ||
        'hideKeyboard' == a ||
        'hideToast' == a ||
        'hideLoading' == a ||
        'showNavigationBarLoading' == a ||
        'hideNavigationBarLoading' == a ||
        'canIUse' == a ||
        'navigateBack' == a ||
        'closeSocket' == a ||
        'closeSocket' == a ||
  ...
  (wx.pro.match = function (a, b) {
    ...
    (wx.pro.showTopTips = function (a, b) {
      return new Promise(function (c, d) {
        a || d('\u7F3A\u5C11\u914D\u7F6E\u9879\uFF01'),
          a.content || d('option.content\u5C5E\u6027\u662F\u5FC5\u987B\u7684');
        var e = b.data.topTips || {};
        e.timeout && (clearTimeout(e.timeout), (e.timeout = 0)),
          a.duration === void 0 && (a.duration = 3e3);
        var f = setTimeout(function () {
          b.setData({ 'topTips.show': !1, 'topTips.timeout': 0 }, function () {
            c();
          });
        }, a.duration);
        b.setData({ topTips: { show: !0, content: a.content, timeout: f } });
      });
    }),
    (wx.pro.initChart = function (a, b) {
      return function (c, d, e) {
        var f = b.init(c, null, { width: d, height: e });
    ...
    (wx.pro.lazyInitChart = function (a, b, c, d) {
      return new Promise(function (e) {
        d.selectComponent(c).init(function (k, l, m) {
          var n = b.init(k, null, { width: l, height: m });
      ...
      return new Promise(function (b, c) {
        wx.getSetting({
          success: function success(d) {
            d.authSetting['scope.writePhotosAlbum']
...
wxPromise(),
  !(function (a) {
    ...
    function c(I, J, K) {
      try {
        return { type: 'normal', arg: I.call(J, K) };
      } catch (L) {
      ...
      return function (N, O) {
        ...
        for (K.method = N, K.arg = O; ; ) {
          ...
          if ('normal' === S.type) {
            ...
            return { value: S.arg, done: K.done };
          }
          'throw' === S.type &&
            ((L = C), (K.method = 'throw'), (K.arg = S.arg));
        }
      };
    }
    function k(I, J) {
      ...
      if (K === s) {
        if (((J.delegate = null), 'throw' === J.method)) {
          if (
            I.iterator.return &&
            ((J.method = 'return'), (J.arg = s), k(I, J), 'throw' === J.method)
          )
            return D;
          (J.method = 'throw'),
            (J.arg = new TypeError(
      ...
      if ('throw' === L.type)
        return (J.method = 'throw'), (J.arg = L.arg), (J.delegate = null), D;
      var M = L.arg;
      if (!M)
        return (
          (J.method = 'throw'),
      ...
      if (M.done)
        (J[I.resultName] = M.value),
          (J.next = I.nextLoc),
          'return' !== J.method && ((J.method = 'next'), (J.arg = s));
      else return M;
      return (J.delegate = null), D;
    }
    function l(I) {
      var J = { tryLoc: I[0] };
      1 in I && (J.catchLoc = I[1]),
        2 in I && ((J.finallyLoc = I[2]), (J.afterLoc = I[3])),
    ...
    (e.prototype = H.constructor = f),
      (f.constructor = e),
      (f[w] = e.displayName = 'GeneratorFunction'),
      (y.isGeneratorFunction = function (I) {
        var J = 'function' == typeof I && I.constructor;
        return (
          !!J && (J === e || 'GeneratorFunction' === (J.displayName || J.name))
        );
      }),
      (y.mark = function (I) {
        return (
          Object.setPrototypeOf
            ...
            : ((I.__proto__ = f), !(w in I) && (I[w] = 'GeneratorFunction')),
          (I.prototype = Object.create(H)),
          I
        );
      }),
      (y.awrap = function (I) {
      ...
      (y.AsyncIterator = h),
      (y.async = function (I, J, K, L) {
        var M = new h(b(I, J, K, L));
        return y.isGeneratorFunction(J)
          ? M
          : M.next().then(function (N) {
      ...
      (n.prototype = {
          ...
          return (
            'break' === I.type || 'continue' === I.type
              ...
              ? ((this.rval = this.arg = I.arg),
                (this.method = 'return'),
                (this.next = 'end'))
              : 'normal' === I.type && J && (this.next = J),
            D
          );
        },
        finish: function finish(I) {
          for (var K, J = this.tryEntries.length - 1; 0 <= J; --J)
            if (((K = this.tryEntries[J]), K.finallyLoc === I))
              return this.complete(K.completion, K.afterLoc), m(K), D;
        },
        ...
        delegateYield: function delegateYield(I, J, K) {
          return (
            (this.delegate = { iterator: o(I), resultName: J, nextLoc: K }),
